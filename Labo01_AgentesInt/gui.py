...
class SudokuUI(Frame):
    ...
    def __initUI(self):
        ...
        self.canvas = Canvas(self, width=WIDTH_B, height=HEIGHT_B, background='gray')
        ...
        self.clear_button = Button(self, text="Reset", command=self.__clear_board, width=15, height=5, background='blue')
            ...
            for j in range(9):
                ...
                if cell != 0:
                    ...
                    if str(cell) == str(self.original_board[i][j]):
                        self.canvas.create_text(x, y, text=cell, tags="numbers", fill="white")
                    else:
                        self.canvas.create_text(x, y, text=cell, tags="numbers", fill="green")
